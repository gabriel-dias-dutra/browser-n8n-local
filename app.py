...
from browser_use import BrowserConfig, BrowserSession
...
class TaskStatus(str, Enum):
    ...
    # Task is in the process of stopping (transitional state)
    STOPPING = "stopping"
